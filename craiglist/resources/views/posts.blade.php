				...
				<div class="col-md-8">
					<div class="posts">
						...
						<div class="post post-row">
								<a class="post-img" href="{{url('forum/thread/' . $post->id)}}"><img src="{{asset('callie/img/post-13.jpg')}}" alt=""></a>
								<div class="post-body">
									<div class="post-category">
										<a href="#">{{strtoupper($name)}}</a>									
									</div>
								<h3 class="post-title"><a href="{{url('forum/thread' . $post->id)}}">{{$post->title}}</a></h3>
									<ul class="post-meta">
