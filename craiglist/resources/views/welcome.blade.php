            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="post">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-1.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                        ...
                        <div class="col-md-6">
                            <div class="post">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-2.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                        ...
                        <div class="col-md-6">
                            <div class="post">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-4.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="post post-sm">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-9.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                                        <a href="category">Lifestyle</a>
                                    </div>
                                    <h3 class="post-title title-sm"><a href="{{url('forum/thread')}}">Mel ut impetus suscipit tincidunt. Cum id ullum laboramus persequeris.</a></h3>
                                    <ul class="post-meta">
                                        <li><a href="author">John Doe</a></li>
                                        <li>20 April 2018</li>
                                    </ul>
                        ...
                        <div class="col-md-4">
                            <div class="post post-sm">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title title-sm"><a href="{{url('forum/thread')}}">Postea senserit id eos, vivendo periculis ei qui</a></h3>
                                    <ul class="post-meta">
                                        <li><a href="author">John Doe</a></li>
                                        <li>20 April 2018</li>
                                    </ul>
                        ...
                        <div class="col-md-4">
                            <div class="post post-sm">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-11.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                                        <a href="category">Technology</a>
                                    </div>
                                    <h3 class="post-title title-sm"><a href="{{url('forum/thread')}}">Sed ut perspiciatis, unde omnis iste natus error sit</a></h3>
                                    <ul class="post-meta">
                                        <li><a href="author">John Doe</a></li>
                                        <li>20 April 2018</li>
                                    </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="post post-sm">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-10.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                                        <a href="category">Travel</a>
                                    </div>
                                    <h3 class="post-title title-sm"><a href="{{url('forum/thread')}}">Ne bonorum praesent cum, labitur persequeris definitionem quo cu?</a></h3>
                                    <ul class="post-meta">
                                        <li><a href="author">John Doe</a></li>
                                        <li>20 April 2018</li>
                                    </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="post post-sm">
                                <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-3.jpg')}}" alt=""></a>
                                <div class="post-body">
                                    <div class="post-category">
                                        <a href="category">Lifestyle</a>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <!-- post -->
                    <div class="post">
                        <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/post-5.jpg')}}" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category">Lifestyle</a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <!-- post -->
                    <div class="post post-widget">
                        <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/widget-6.jpg')}}" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category">Fashion</a>
                                <a href="category">Lifestyle</a>
                ...
                <div class="col-md-4">
                    <!-- post -->
                    <div class="post post-widget">
                        <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/widget-8.jpg')}}" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category">Travel</a>
                            </div>
                    ...
                    <!-- post -->
                    <div class="post post-widget">
                        <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/widget-9.jpg')}}" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category">Technology</a>
                            </div>
                    ...
                    <!-- post -->
                    <div class="post post-widget">
                        <a class="post-img" href="{{url('forum/thread')}}"><img src="{{asset('callie/img/widget-10.jpg')}}" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category">Lifestyle</a>
                            </div>
